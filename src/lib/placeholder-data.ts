...
export const blogPosts: BlogPost[] = [
  {
    ...
    difficulty: 'Beginner',
    content: 'A comprehensive guide to the basics of cybersecurity. Learn what cybersecurity is, why it\'s important, common threats, and the fundamental principles of cyber defense.',
